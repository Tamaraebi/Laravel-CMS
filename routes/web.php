...
Route::get('/console/entries/edit/{type:id}', [EntriesController::class, 'editForm'])->where('type', '[0-9]+')->middleware('auth');
Route::post('/console/entries/edit/{type:id}', [EntriesController::class, 'edit'])->where('type', '[0-9]+')->middleware('auth');
Route::get('/console/entries/delete/{type:id}', [EntriesController::class, 'delete'])->where('type', '[0-9]+')->middleware('auth');